  ...
  return (
    <>
      <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4 justify-center items-center">
        <div className="box h-[200px] bg-red-500 flex  items-center justify-center rounded-lg">
        ...
        <div className="box h-[200px] bg-green-500 flex  items-center justify-center rounded-lg">
          <h1 className="text-white text-2xl font-bold">
            Products
        ...
        <div className="box h-[200px] bg-blue-500 flex  items-center justify-center rounded-lg">
          <h1 className="text-white text-2xl font-bold">
